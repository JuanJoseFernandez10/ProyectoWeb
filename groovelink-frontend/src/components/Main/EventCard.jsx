    ...
    return (
        ...
        >
            <div className={`event-card-media relative shrink-0 overflow-hidden rounded-t-2xl max-[500px]:rounded-t-xl max-[360px]:rounded-t-lg sm:rounded-t-3xl ${featured ? 'min-h-36 max-[500px]:min-h-28 max-[400px]:min-h-24 sm:min-h-50' : 'h-32 max-[500px]:h-24 max-[400px]:h-20 sm:h-44'}`}>
                ...
                <div className="event-card-category absolute left-2.5 top-2.5 max-w-[calc(100%-1.25rem)] truncate rounded-full bg-text-primary/90 px-2.5 py-1 text-[10px] font-extrabold uppercase tracking-[0.08em] text-ink shadow max-[500px]:left-2 max-[500px]:top-2 max-[500px]:px-2 max-[500px]:py-0.5 max-[500px]:text-[9px] max-[500px]:tracking-[0.04em] max-[360px]:left-1 max-[360px]:top-1 max-[360px]:px-1.5 max-[360px]:text-[8px] sm:left-4 sm:top-4 sm:px-3 sm:text-xs sm:tracking-[0.16em]">
                    {event.category}
                </div>
                <div className="event-card-date absolute bottom-2.5 left-2.5 rounded-xl bg-ink/80 px-2.5 py-1.5 text-text-primary shadow-md backdrop-blur-sm max-[500px]:bottom-2 max-[500px]:left-2 max-[500px]:rounded-lg max-[500px]:px-2 max-[500px]:py-1 max-[360px]:bottom-1 max-[360px]:left-1 max-[360px]:px-1.5 max-[360px]:py-0.5 sm:bottom-4 sm:left-4 sm:rounded-2xl sm:px-3 sm:py-2">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-text-primary/80 max-[500px]:text-[9px] max-[500px]:tracking-[0.08em] max-[360px]:text-[8px] sm:text-xs sm:tracking-[0.18em]">Fecha</p>
                    <p className="text-sm font-black leading-none max-[500px]:text-xs max-[360px]:text-[10px] sm:text-lg">{event.date}</p>
                    <p className="text-xs font-medium text-text-primary/85 max-[500px]:text-[10px] max-[360px]:text-[9px]">{event.time}</p>
                </div>
            </div>
