...
function AccesCard() {
  const [modo, setModo] = useState('login'); // 'login' | 'registro'
    ...
    return (
        <div className="flex flex-col md:flex-row justify-between rounded-3xl mt-5 bg-amber-300/20 backdrop-blur-2xl shadow-2xl shadow-amber-200 overflow-hidden w-full max-w-5xl mx-auto">
